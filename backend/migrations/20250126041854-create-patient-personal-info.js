...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('patient_personal_infomations', {
      ...
      gender: { 
        type: Sequelize.ENUM('Perempuan', 'Laki-laki', 'Lain-lain'), 
        allowNull: false 
      },
      blood_type: { 
      ...
      maritial_status: { 
        type: Sequelize.ENUM('Menikah', 'Single', 'Duda/Janda'), 
        allowNull: false 
      },
      religion: { 
        type: Sequelize.ENUM('Islam', 'Kristen', 'Katolik', 'Hindu', 'Budha', 'Lain-lain') 
      },
      contact_number: { 
        type: Sequelize.STRING, 
        allowNull: false 
      ...
      id_type: { 
        type: Sequelize.ENUM('KTP', 'Passport'), 
        allowNull: false 
      },
      id_number: { 
        type: Sequelize.STRING, 
      ...
      education: { 
        type: Sequelize.ENUM('SD', 'SMP', 'SMA/K', 'D3', 'D4/S1', 'S2', 'Lain-lain'), 
        allowNull: false 
      },
      created_at: {
        type: Sequelize.DATE,
